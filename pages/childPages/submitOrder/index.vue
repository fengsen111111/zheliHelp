<template>
	<view class="bgF4F6F5">
			...
			<view class="bg-white px30 py20 mt30">
				...
				<view class="flex justify-around col333333 mt20">
					<view class="flex">
						...
						<view class="text28">电商自提</view>
					</view>
					<view class="flex">
						<uni-icons type="circle" size="20"></uni-icons>
						<view class="text28">单位自提</view>
					</view>
				</view>
			</view>
			<!--  -->
		...
		<view class="bg-white items-center justify-between px40 py20 mt30 flex">
			<view class="flex">
				<view class="">
					<image src="https://img.picui.cn/free/2024/08/16/66bf089662182.png" class="w86 h86 radius12"
						mode=""></image>
				</view>
				<view class="ml20">
					<view class="text24 col333333 font-bold">陈昌银磁器口陈麻花</view>
					<view class="flex mt10 items-center text28">
