	...
	<view class="bgF4F6F5">
		<view class="">
			<uni-nav-bar :border="false" :fixed="true" background-color="#ffffff" status-bar left-icon="left"
				title="兑换订单" color="#000000" @clickLeft="back" />
		</view>
		<!--  -->
		<view class="">
		...
		<view class="">
			<view class="bg-white px30 py20 mt30">
				<view class="col333333 w-full justify-between text30 flex items-center">
					<view class="flex items-center">
						<view class="">商品列表</view>
					</view>
				</view>
				<view class="px20 flex items-center justify-between mt30" v-for="item in [1,2,3,4,5]" :key="item">
					<image src="https://img.picui.cn/free/2024/08/16/66bf089662182.png" class="w100 h100 radius12"
						mode=""></image>
					<view class="text24 font-bold ml20">
						<view class="">	陈昌银重庆磁器口精品豪华陈麻花百草味藕片零食</view>
						<view class="col999999">袋装(500g)</view>
					</view>
					<view class="col333333 ml20">
						X666
					</view>
				</view>
			</view>
		...
		<view class="">
			<view class="flex w-full py14 items-center justify-between fixed bottom0 bg-white">
				<view class="px40 w-full">
					<view class="w-full bgFA6C2F col-white radius12 py20  text-center" @click="togglePay('bottom')">
						提交
					</view>
				</view>
			</view>
